...
# Function to downloa images from ocean currents website
def get_OCimages(url):
    ...
    if 'pctiles' in url:
        dir = '/Users/Michael/Documents/Work/UNSW/Work/QC_reports/' + \
...
OC_plots_in_dir = glob.glob('/Users/Michael/Documents/Work/UNSW/Work/QC_reports/' + \
...
if len(OC_plots_in_dir) == 0:
    ...
    for n_images in range(numb_images):
        ...
        img=mpimg.imread('/Users/Michael/Documents/Work/UNSW/Work/QC_reports/' + \
    ...
    #--------------    
    # save figure
    fig.savefig('/Users/Michael/Documents/Work/UNSW/Work/QC_reports/Example_data_BMP070_29/OceanCurrents/' + \
